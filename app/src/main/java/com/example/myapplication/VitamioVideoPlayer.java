...
import com.example.myapplication.view.VitamioVideoView;
...
/**
 * 作者：杨光福 on 2016/7/18 10:30initialize
 * 微信：yangguangfu520
 * QQ号：541433511
 * 作用：系统播放器
 */
public class VitamioVideoPlayer extends Activity implements View.OnClickListener {
    ...
    private void findViews() {
        Log.d("sgw_d", "VitamioVideoPlayer findViews: isInitialized");
        Vitamio.isInitialized(this);
        //Vitamio.initialize(VitamioVideoPlayer.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("sgw_d", "VitamioVideoPlayer onCreate: ");
        LogUtil.e("onCreate--");
...
//        videoview.setMediaController(new MediaController(this));
    ...
    private void setData() {
        ...
        if (mediaItems != null && mediaItems.size() > 0) {
            ...
            Log.d("sgw_d", "VitamioVideoPlayer setData: mediaItem.getData() ="+mediaItem.getData());
            videoview.setVideoPath(mediaItem.getData());
    ...
    private void getData() {
        ...
        Log.d("sgw_d", "VitamioVideoPlayer getData: ");
